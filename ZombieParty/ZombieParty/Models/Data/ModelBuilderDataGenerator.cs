    ...
    public static class ModelBuilderDataGenerator
    {
        public static void GenerateData(this ModelBuilder builder)
        {
            ...
            builder.Entity<Weapon>().HasData(
                ...
                new Weapon() { WeaponId = 3, Name = "Hehe", Description = "Michael Jackson's Hehe", Force = 1000, Image = "https://i.pinimg.com/736x/ac/3f/4a/ac3f4a2058c70a1a7da78a373819639d.jpg", Price = 1200, Qty = 3, QtyBought = 1, CreatedDate = new DateTime(2001, 10, 28) }
            );
            #endregion
        }
    }
